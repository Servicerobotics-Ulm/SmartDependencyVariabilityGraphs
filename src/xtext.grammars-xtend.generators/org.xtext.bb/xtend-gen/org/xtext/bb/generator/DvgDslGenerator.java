...
public class DvgDslGenerator {
  ...
  private StringBuilder IMPORT_CODE;
  ...
  public String root(final DVG dvg) {
    Node _node = new Node();
    this.no = _node;
    ...
    this.IMPORT_CODE = _stringBuilder_5;
    StringBuilder _stringBuilder_6 = new StringBuilder();
    this.SOLVE_CODE = _stringBuilder_6;
    StringBuilder _stringBuilder_7 = new StringBuilder();
    this.INITIALIZATION_CODE = _stringBuilder_7;
    StringBuilder _stringBuilder_8 = new StringBuilder();
    this.LOCAL_RESOLUTION_CODE = _stringBuilder_8;
    StringBuilder _stringBuilder_9 = new StringBuilder();
    this.CALL_SEQUENCE_CODE = _stringBuilder_9;
    HashMap<String, Pattern> _hashMap_3 = new HashMap<String, Pattern>();
    this.PATTERN_MAP = _hashMap_3;
    HashMap<Pattern, Boolean> _hashMap_4 = new HashMap<Pattern, Boolean>();
    this.IS_RESOLVED_MAP = _hashMap_4;
    HashMap<Pattern, List<String>> _hashMap_5 = new HashMap<Pattern, List<String>>();
    this.DEPENDENCY_MAP = _hashMap_5;
    ...
    for (final Map.Entry<Pattern, List<String>> i : _entrySet) {
      {
        ...
        if ((isSAM && (((i.getKey() instanceof RPRO) || (i.getKey() instanceof APRO)) || (i.getKey() instanceof SAPRO)))) {
          isValid = false;
        }
        if (((!isSAM) && (((i.getKey() instanceof CONT) || (i.getKey() instanceof PTCC)) || (i.getKey() instanceof EPROD)))) {
          isValid = false;
          String _name = i.getKey().getName();
          String _plus = ("ERROR: There is no SAM-Situation for " + _name);
          String _plus_1 = (_plus + "! Please fix the problem.");
    ...
    if (isValid) {
      ...
      for (final Map.Entry<String, Integer> i_1 : _entrySet_1) {
        {
          ...
          this.CALL_SEQUENCE_CODE.append(_plus_3);
          this.CALL_SEQUENCE_CODE.append("\n\t\t");
        }
      }
      Set<Map.Entry<String, Integer>> _entrySet_2 = this.PASSIVE_LOOKUP.entrySet();
      for (final Map.Entry<String, Integer> i_2 : _entrySet_2) {
        {
          String _key = i_2.getKey();
          String _plus = ("passive.put(\"" + _key);
          String _plus_1 = (_plus + "\",");
          Integer _value = i_2.getValue();
          String _plus_2 = (_plus_1 + _value);
          String _plus_3 = (_plus_2 + ");");
          this.CALL_SEQUENCE_CODE.append(_plus_3);
          this.CALL_SEQUENCE_CODE.append("\n\t\t");
      ...
      Set<Map.Entry<String, Integer>> _entrySet_3 = this.PASSIVE_LOOKUP.entrySet();
      for (final Map.Entry<String, Integer> i_3 : _entrySet_3) {
        String _key = i_3.getKey();
        String _plus = (_key + " : ");
        Integer _value = i_3.getValue();
        String _plus_1 = (_plus + _value);
        System.out.println(_plus_1);
      }
      System.out.println("PASSIVE LOOKUP_LIST");
      for (final AbstractMap.SimpleEntry<String, Integer> i_4 : this.PASSIVE_LOOKUP_LIST) {
        String _key_1 = i_4.getKey();
        String _plus_2 = (_key_1 + " : ");
        Integer _value_1 = i_4.getValue();
        String _plus_3 = (_plus_2 + _value_1);
        System.out.println(_plus_3);
      }
      System.out.println("ACTIVE");
      Set<Map.Entry<String, Integer>> _entrySet_4 = this.ACTIVE.entrySet();
      for (final Map.Entry<String, Integer> i_5 : _entrySet_4) {
        String _key_2 = i_5.getKey();
        String _plus_4 = (_key_2 + " : ");
        Integer _value_2 = i_5.getValue();
        String _plus_5 = (_plus_4 + _value_2);
        System.out.println(_plus_5);
      }
      System.out.println("---------");
      int _size = this.PASSIVE_LOOKUP.size();
  ...
  public StringBuilder resolveNext(final Pattern lp) {
    StringBuilder _xblockexpression = null;
    {
      ...
      if ((lp instanceof INIT)) {
          ...
          if (((((INIT)lp).getAinip().getInterface() != null) && Objects.equal(((INIT)lp).getAinip().getInterface(), Interface.STANDARD))) {
            ...
            if (((((INIT)lp).getAinip().getInterface() != null) && Objects.equal(((INIT)lp).getAinip().getInterface(), Interface.FROMTCL))) {
              ...
              if (_tripleNotEquals) {
                ...
                String _plus = ("(setf result (get-value (tcl-kb-query :key \'(is-a name) :value `((is-a " + _kbisa_1);
                String _plus_1 = (_plus + ")(name ");
                String _kbname = ((INIT)lp).getAinip().getKbname();
                String _plus_2 = (_plus_1 + _kbname);
                String _plus_3 = (_plus_2 + "))) \'");
                String _kbvalue = ((INIT)lp).getAinip().getKbvalue();
                String _plus_4 = (_plus_3 + _kbvalue);
                String _plus_5 = (_plus_4 + "))\n");
                this.CODE_KB.append(_plus_5);
                String _name = ((INIT)lp).getAinip().getName();
                String _plus_6 = ("(writeToFile \'" + _name);
                String _plus_7 = (_plus_6 + " ");
                String _plus_8 = (_plus_7 + "result)\n");
                this.CODE_KB.append(_plus_8);
              } else {
                ...
                if (_tripleNotEquals_1) {
                  ...
                  String _plus_9 = ("(execute \'(" + _tcbname_1);
                  String _plus_10 = (_plus_9 + "))\n");
                  this.CODE_TCB_CALL.append(_plus_10);
                  String _tcbname_2 = ((INIT)lp).getAinip().getTcbname();
                  String _plus_11 = ("(define-tcb (" + _tcbname_2);
                  String _plus_12 = (_plus_11 + ")\n");
                  this.CODE_TCB.append(_plus_12);
                  ...
                  if (_isIsList) {
                    ...
                    String _plus_13 = ("(" + _tclCmd);
                    String _plus_14 = (_plus_13 + " => ?p0)\n");
                    this.CODE_TCB.append(_plus_14);
                    String _name_1 = ((INIT)lp).getName();
                    String _plus_15 = ("(writeToFile \'" + _name_1);
                    String _plus_16 = (_plus_15 + " ?p0");
                    this.CODE_TCB.append(_plus_16);
                  } else {
                    String _tclCmd_1 = ((INIT)lp).getAinip().getTclCmd();
                    String _plus_17 = ("(" + _tclCmd_1);
                    String _plus_18 = (_plus_17 + " => ");
                    this.CODE_TCB.append(_plus_18);
                    ...
                    String _plus_19 = ("(" + _tcbname_3);
                    String _plus_20 = (_plus_19 + "_toList ");
                    this.CODE_TCB.append(_plus_20);
                    for (int i = 0; (i < ((INIT)lp).getAinip().getNrParams()); i++) {
                      this.CODE_TCB.append((("?p" + Integer.valueOf(i)) + " "));
                    }
                    this.CODE_TCB.append(")\n");
                  ...
                  if (_isIsList_1) {
                    ...
                    String _plus_21 = ("(define-tcb (" + _tcbname_4);
                    String _plus_22 = (_plus_21 + "_toList ");
                    this.CODE_TCB.append(_plus_22);
                    for (int i = 0; (i < ((INIT)lp).getAinip().getNrParams()); i++) {
                      this.CODE_TCB.append((("?p" + Integer.valueOf(i)) + " "));
                    }
                    this.CODE_TCB.append(")\n");
                    ...
                    this.CODE_TCB.append("))\n");
                    String _name_2 = ((INIT)lp).getAinip().getName();
                    String _plus_23 = ("(writeToFile \'" + _name_2);
                    String _plus_24 = (_plus_23 + " listvar");
                    String _plus_25 = (_plus_24 + ")\n");
                    this.CODE_TCB.append(_plus_25);
                    this.CODE_TCB.append("))\n");
                    this.CODE_TCB.append(")\n");
                  }
                }
              ...
              if (((((INIT)lp).getAinip().getInterface() != null) && Objects.equal(((INIT)lp).getAinip().getInterface(), Interface.TOTCL))) {
                ...
                String _plus_26 = ("l.add(\"" + _toTclName);
                String _plus_27 = (_plus_26 + "\");\n");
                this.TO_TCL.append(_plus_27);
                int _toTclInst = ((INIT)lp).getAinip().getToTclInst();
                String _plus_28 = ("l.add(" + Integer.valueOf(_toTclInst));
                String _plus_29 = (_plus_28 + ");\n");
                this.TO_TCL.append(_plus_29);
                String _name_3 = ((INIT)lp).getAinip().getName();
                String _plus_30 = ("TO_TCL.put(\"" + _name_3);
                String _plus_31 = (_plus_30 + "\",l);\n");
                this.TO_TCL.append(_plus_31);
              }
            }
          }
        }
        ...
        if (_equals) {
          this.ACTIVE.put(((INIT)lp).getAinip().getName(), Integer.valueOf(this.he.getVSPInitSize(((INIT)lp).getAinip())));
        } else {
          VT _vt_1 = ((INIT)lp).getAinip().getVt();
          boolean _equals_1 = Objects.equal(_vt_1, VT.CONSTANT);
          if (_equals_1) {
            this.CONSTANT.put(((INIT)lp).getAinip().getName(), Integer.valueOf(this.he.getVSPInitSize(((INIT)lp).getAinip())));
          } else {
            this.PASSIVE_LOOKUP.put(((INIT)lp).getAinip().getName(), Integer.valueOf(this.he.getVSPInitSize(((INIT)lp).getAinip())));
            String _name_4 = ((INIT)lp).getAinip().getName();
            int _vSPInitSize = this.he.getVSPInitSize(((INIT)lp).getAinip());
            AbstractMap.SimpleEntry<String, Integer> _simpleEntry = new AbstractMap.SimpleEntry<String, Integer>(_name_4, Integer.valueOf(_vSPInitSize));
                ...
                if (_tripleNotEquals_2) {
                  ...
                  if ((_f_1 instanceof EquivalenceFork)) {
                    ...
                    if ((_f_2 instanceof ConditionalFork)) {
                      ...
                      AbstractMap.SimpleEntry<String, Integer> _simpleEntry_1 = new AbstractMap.SimpleEntry<String, Integer>(_name_5, Integer.valueOf(_size));
      ...
      if ((lp instanceof MAGR)) {
        ...
        if ((!(lp instanceof INIT))) {
          _xifexpression_1 = this.CALL_SEQUENCE_CODE.append(this.jf.generateCallSequenceCode(lp.getName(), inputSet));
        }
      ...
      for (int i = 0; (i < p.getAggr().size()); i++) {
        {
          ...
          code.append("\n\t");
          lcode.append(this.resolveAggregation(p.getName(), name, p.getAggr().get(i)));
          lcode.append("\n");
        }
      }
      code.append("\n");
  ...
  public String resolveAggregation(final String pname, final String fname, final AGGR la) {
    StringBuilder code = new StringBuilder();
    String vsp = null;
    String obj = null;
  ...
  public String resolve(final EPROD p) {
    ...
    if (this.CHECK_FOR_IS_SAM_IN_CONTRADICTION) {
      ...
      code.append("\n\t\t");
      String _name_1 = p.getName();
      String _plus_1 = ("System.err.println(\"ERROR: There is no SAM-Situation for SAMF pattern " + _name_1);
      String _plus_2 = (_plus_1 + "!\");");
      code.append(_plus_2);
      code.append("\n\t");
      code.append("}");
